...
class VideoLibraryScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: const OjasAppBar(title: 'Learn'),
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.play_circle_outline, size: 64, color: OjasColors.saffron),
              const SizedBox(height: OjasDimensions.md),
              const Text('Video Library', style: OjasTextStyles.headlineLarge),
              const SizedBox(height: OjasDimensions.sm),
              Text(
                'Steps 17–19 — Content feature coming soon',
