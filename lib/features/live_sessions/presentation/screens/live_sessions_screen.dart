...
class LiveSessionsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: const OjasAppBar(title: 'Live Sessions'),
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.live_tv_outlined, size: 64, color: OjasColors.saffron),
              const SizedBox(height: OjasDimensions.md),
              const Text('Live Sessions', style: OjasTextStyles.headlineLarge),
              const SizedBox(height: OjasDimensions.sm),
              Text(
                'Steps 27–29 — Live sessions coming soon',
